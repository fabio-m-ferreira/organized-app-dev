...
export { default as IconLanguageGroup } from './IconLanguageGroup';
...
export { default as IconNavigateLeft } from './IconNavigateLeft';
export { default as IconNavigateRight } from './IconNavigateRight';
